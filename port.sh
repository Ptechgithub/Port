...
echo -e "The SSH port has been changed from $current_port to $new_port. \n Please log in with the new port. If you cannot log in, please check whether the firewall allows $new_port."
